...
use Bytescreen\DoctrineEncryptBundle\Subscribers\DoctrineEncryptSubscriber;
...
abstract class AbstractCommand extends ContainerAwareCommand
{
    ...
    protected function initialize(InputInterface $input, OutputInterface $output)
    {
        ...
        $this->subscriber = $container->get('bytescreen_doctrine_encrypt.subscriber');
    }
    ...
    protected function getEncryptionableProperties($entityMetaData)
    {
        ...
        foreach ($propertyArray as $property) {
            if ($this->annotationReader->getPropertyAnnotation($property, 'Bytescreen\DoctrineEncryptBundle\Configuration\Encrypted')) {
                $properties[] = $property;
            }
        }
