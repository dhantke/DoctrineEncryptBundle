...
namespace Bytescreen\DoctrineEncryptBundle\Subscribers;
...
use \ReflectionClass;
use Bytescreen\DoctrineEncryptBundle\Encryptors\EncryptorInterface;
...
class DoctrineEncryptSubscriber implements EventSubscriber {
     ...
     */
    const ENCRYPTOR_INTERFACE_NS = 'Bytescreen\DoctrineEncryptBundle\Encryptors\EncryptorInterface';

    /**
     * Encrypted annotation full name
     */
    const ENCRYPTED_ANN_NAME = 'Bytescreen\DoctrineEncryptBundle\Configuration\Encrypted';
